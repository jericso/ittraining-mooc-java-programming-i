...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(atlantaTwoBedroomApt.priceDifference(bangorThreeBedroomApt)); //35400
        System.out.println(atlantaTwoBedroomApt.priceDifference(atlantaTwoBedroomApt)); //0
